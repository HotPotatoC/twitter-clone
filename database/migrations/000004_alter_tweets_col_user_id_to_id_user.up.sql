BEGIN;
ALTER TABLE IF EXISTS tweets DROP CONSTRAINT IF EXISTS "tweets_user_id_created_at_index";
ALTER TABLE IF EXISTS users DROP CONSTRAINT IF EXISTS "tweets_user_id_foreign";

...
export default defineComponent({
  ...
  components: { Dialog, IconImage, IconX },
  props: {
    show: {
      type: Boolean,
      default: false,
...
<template>
  <Dialog size="2xl" :show="show" @close="close">
    <form @submit.prevent="dispatch" class="w-full px-4 relative">
      <div
        @input="(e) => (tweetContent = e.target.innerText)"
        :contenteditable="true"
        placeholder="What's happening?"
        class="mt-3 pb-5 w-full focus:outline-none dark:bg-black dark:text-light whitespace-pre-wrap break-words"
      ></div>
      <div
